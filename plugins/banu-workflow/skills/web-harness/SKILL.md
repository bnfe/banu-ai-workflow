...
请阅读当前项目结构、配置文件、包管理文件、构建脚本和主要源码目录，把这套 BANU 协作模板完整接入目标仓库。
...
3. 对 `docs/architecture.md`、`docs/conventions.md`、`docs/api.md` 按目标仓库实际情况补全内容。
4. 对 `docs/decisions.md`、`tasks/todo.md`、`tasks/lessons.md`、`tasks/review.md` 保持模板职责和结构，不擅自改写固定模板区。
